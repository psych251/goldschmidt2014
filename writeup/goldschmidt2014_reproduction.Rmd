---
title: "Replication of Study 1 by Goldschmidt et al. (2014, Journal of Consulting and Clinical Psychology)"
...
In the study "Ecological Momentary Assessment of Stressful Events and Negative Affect in Bulimia Nervosa", (Goldschmidt et al., 2014) sought to examine the time course of events and affect preceding binging and purging in bulimia nervosa (BN) patients. The authors found that an increase in negative affect (as opposed to state affect itself) following stressful events mediates the relationship between stress and bulimic events. This was tested through a multilevel structural equation mediation model where negative affect at time 2 mediated the relationship between stressful events at time 1 and bulimic events at time 2 while controlling for levels of negative affect at time 1. The present reproduction effort aims to reproduce this finding in the [lavaan](http://lavaan.ugent.be) package in R.
...
Participants completed a phone-administered structured interview to determine preliminary BN status. Eligible participants came to an in-person informational session where they completed a baseline assessment of BN symptoms using the SCID-I/P (First, Spitzer, Gibbon, & Williams, 1997). For two weeks, participants filled out six semi-randomly delivered ecological momentary assessment (EMA) surveys each day. In addition, the participants filled out daily diary surveys prior to bed and event-contingent surveys each time they engaged in an episode of binging or purging. These surveys assessed stressful events that occurred throughout the day, levels of negative affect, and bulimic events (i.e. binging, purging by vomiting or use of laxatives).

Stressful events were meaured using the Daily Stress Inventory (DSI; Brantley, Waggoner, Jones, and Rappaport, 1987). This instrument asks participants to select stressful events that occurred from a list of 60 events and to record when and how stressful these event were. Negative affects was measured with an abridged version of the Positive and Negative Affect Schedule (PANAS; Watson et al., 1988).
